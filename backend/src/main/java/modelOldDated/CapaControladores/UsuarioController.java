...
import modelOldDated.CapaEntidades.Imagen;
import modelOldDated.CapaEntidades.Habilidad;
import modelOldDated.CapaEntidades.Monedero;
import modelOldDated.CapaEntidades.Usuario;
import modelOldDated.CapaGestion.GestionUsuario;
import modelOldDated.CapaEntidades.Necesidad;
...
public class UsuarioController {
    ...
    static class CatalogoDTO {
        public java.util.List<Habilidad> habilidades;
        public java.util.List<Necesidad> necesidades;
    }
